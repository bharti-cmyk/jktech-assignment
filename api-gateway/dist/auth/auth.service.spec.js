...
describe('AuthService', () => {
    ...
    describe('create', () => {
        it('should create a new user', async () => {
            ...
            const mockUser = Object.assign(Object.assign({ id: 1 }, createUserDto), { passwordHash: 'hashed-password' });
        ...
        it('should throw an error if the role is not found', async () => {
            ...
            await expect(authService.create(createUserDto)).rejects.toThrow('Invalid role ID');
            expect(mockRoleRepository.findOne).toHaveBeenCalledWith({
                where: { name: 'admin' },
            });
        });
